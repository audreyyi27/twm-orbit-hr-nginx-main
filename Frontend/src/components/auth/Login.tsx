...
export function Login() {
  ...
  // Use backend URL directly for login (bypasses Next.js routing issues)
  const API_BASE = process.env.NEXT_PUBLIC_API_BASE || "/api";
  const BACKEND_URL = process.env.NEXT_PUBLIC_BACKEND_URL || "http://localhost:8000";
  
  // For login, use backend directly to avoid rewrite issues
            ...
            <div className="relative bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl w-full max-w-md p-8 space-y-8 transform transition-all hover:scale-[1.01]">
              ...
              <div className="text-center">
                ...
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Taiwan Mobile Indonesia Attendance
                </h1>
