...
class Project(Base):
    ...
    assigned_employees = relationship("EmployeeProjectTask", back_populates="project", cascade="all, delete-orphan")
...
class EmployeeProjectTask(Base):
    ...
    project_id = Column(UUID(as_uuid=True), ForeignKey("employee_projects.project_id", ondelete='CASCADE'), nullable=False)  # ✅ Added ondelete
    contribution = Column(String(100))  # ✅ Added length
